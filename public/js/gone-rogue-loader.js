...
(function () {
  ...
  var SCRIPTS = [
    ...
    'js/tutorial-floors.js?v=20260526a',
    'js/floor-metadata-registry.js',
    'js/ui/onboarding-splash.js',
    'js/ui/character-creation.js?v=20260526a',
    ...
    'js/str-combat-engine.js?v=20260525c',
    ...
    'js/key-loot-gen.js?v=20260525a',
    'js/currency-spawning.js?v=20260307k',
    'js/rendering-ui.js',
    'js/vendor-system.js',
    'js/inventory-management.js?v=20260525a',
    'js/ground-effects-system.js',
    'js/card-action-system.js',
    'js/locked-gate-system.js?v=20260526a',
    'js/active-item-system.js',
    'js/vent-system.js',
    'js/npc-gate-system.js',
    'js/death-exit-system.js?v=20260525a',
    ...
    'js/player-interaction-system.js?v=20260526a',
    ...
    'js/move-player-system.js?v=20260526c',
    'js/agent-api-system.js?v=20260525c',
    'js/run-start-system.js?v=20260525a',
    'js/game-state-api.js?v=20260526b',
    'js/tutorial-floor-gen.js?v=20260526a',
